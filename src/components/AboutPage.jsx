    ...
    <div className="relative min-h-screen bg-[#0a0a0a] pt-32 pb-20 px-6 md:px-12 lg:px-20 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
        ...
        <div className="lg:col-span-6 flex flex-col gap-8">
          ...
          >
            I’m a Software Engineer with experience in ERP systems and factory automation. Currently a Software Engineer at POSCO DX, bridging the gap between software development and industrial operations to build reliable enterprise solutions.
          </motion.p>
